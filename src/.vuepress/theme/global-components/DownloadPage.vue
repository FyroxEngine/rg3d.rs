<template>
    <v-container class="pb-9">
        ...
        <v-row>
            <v-col align="center">
                <CpCode command="cargo install fyrox-project-manager --version=1.0.0-rc.2"> </CpCode>
            </v-col>
        </v-row>
...
export default {
    data() {
        ...
        var icon = "";
        var version = "1.0.0";
        var windows = "https://fyrox.rs/assets/releases/1.0.0/fyrox-project-manager-win-x86_64.zip";
        var mac = "https://fyrox.rs/assets/releases/1.0.0/fyrox-project-manager-macos-x86_64.zip";
        var linux = "https://fyrox.rs/assets/releases/1.0.0/fyrox-project-manager-linux-x86_64.zip";
