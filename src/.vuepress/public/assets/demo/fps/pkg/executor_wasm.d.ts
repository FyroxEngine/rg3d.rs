...
export interface InitOutput {
  ...
  readonly closure18456_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__hf40205624f27c18e: (a: number, b: number) => void;
  readonly closure61836_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h8cfff34f40d693aa: (a: number, b: number) => void;
  readonly closure18462_externref_shim: (a: number, b: number, c: any, d: any) => void;
