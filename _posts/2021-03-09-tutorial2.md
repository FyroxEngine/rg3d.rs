...
**rg3d version**: 0.20  
**rusty-editor version**: [0.8](https://github.com/mrDIMAS/rusty-editor/releases/tag/v0.8)
(commit [3b63340](https://github.com/rg3dengine/rusty-editor/commit/3b63340cc8b81039db4d9a3434607f838c606e36))
...
{% include video.html id="GmVAdBdnqeM" %}
...
This piece of code just loads a [weapon model](/assets/tutorial2/resources/m4.zip) and saves an instance handle for 
...
![Weapon](/assets/tutorial2/weapon.jpg)
...
![Weapon](/assets/tutorial2/shooting.jpg)
...
[spark texture](/assets/tutorial2/resources/spark.png), it should be placed in `data/textures`. Now we need to find
...
![Weapon](/assets/tutorial2/impact.jpg)
