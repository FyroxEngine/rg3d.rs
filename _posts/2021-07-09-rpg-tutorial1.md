...
ZIP archive which can be downloaded [here](/assets/rpg-tutorial1/data.zip). Once you've downloaded it, unpack it in `./data` folder.
...
![Scene](/assets/rpg-tutorial1/scene.jpg)
